...
function CargarAreasEmpresa() {
    fetch('php/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_empresa/get_area_empresa.php')
    ...
    document.getElementById('countryCode').addEventListener('change', function() {
        ...
        this.style.backgroundImage = 'url(imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/nueva_cotizacion/banderas/' + flag + '.png)';
