...
/* --------------------------------------------------------------------------------------------------------------
    -------------------------------------- INICIO ITred Spa crear_producto_pr .JS --------------------------------------
    ------------------------------------------------------------------------------------------------------------- */
...
// TÍTULO: PARA LA FUNCIÓN DE CARGA DE OPCIONES DEL SELECT
    ...
    function loadSelectOptions(callback) {
        ...
        xhr.open('GET', '../../../php/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_producto/get_tipo_productos.php', true); // Configura la solicitud GET
        xhr.onload = function () {
            if (xhr.status === 200) {
...
/* --------------------------------------------------------------------------------------------------------------
    ---------------------------------------- FIN ITred Spa crear_producto_pr .JS ---------------------------------------
    ------------------------------------------------------------------------------------------------------------- */
