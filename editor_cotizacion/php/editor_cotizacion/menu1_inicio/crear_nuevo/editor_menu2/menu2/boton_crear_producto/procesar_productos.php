...
$base_upload_dir = dirname(dirname(dirname(dirname(__DIR__)))) . '/imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/crear_producto/';
...
// TÍTULO: REDIRECCIÓN
header("Location: crear_producto_pr.php?success=1");
exit()
?>

<!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .CSS -->
<link rel="stylesheet" href="css/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_producto/procesar_productos.css">
