...
<link rel="stylesheet" href="css/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_nueva_cotizacion/cargar_logo_empresa.css">
...
$upload_dir = '../../imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/cotizacion/'; 
...
?>
    ...
    <label for="subir-logo" class="contenedor-logo">
        <?php if (isset($row['ruta_foto']) && !empty($row['ruta_foto'])): 
            ...
            <img src="<?php echo htmlspecialchars('imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/programa_cotizacion/' . $ruta_foto, ENT_QUOTES, 'UTF-8'); ?>" alt="Foto de perfil" id="Previsualizar-logo" class="logo" onclick="document.getElementById('subir-logo').click();" />
        <?php else: ?>
