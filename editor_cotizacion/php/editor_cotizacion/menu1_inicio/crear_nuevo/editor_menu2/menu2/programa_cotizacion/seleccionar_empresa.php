...
<!-- TÍTULO SELECCIÓN DE EMPRESA -->
    ...
    <!-- combo box de seleccionar empresa -->
    ...
    <div class="custom-select" > 
        ...
        <select id="empresa" name="empresa" required>
            ...
            $rutaPrueba = 'imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/programa_cotizacion/Captura de pantalla 2024-08-27 141315.png'; // Ruta manual para probar
            ...
            if (!function_exists('ajustarRuta')) {
                ...
                $rutaManual = 'imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/programa_cotizacion/';
...
<!-- TÍTULO LISTA DE EMPRESAS -->
    ...
    <!-- TITULO LISTA DE EMPRESA QUE MUESTRA EL COMBO BOX -->
