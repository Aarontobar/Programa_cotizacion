...
document.addEventListener('DOMContentLoaded', function() {
    // Cargar bancos
    fetch('php/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_empresa/get_bancos.php')
    ...
    fetch('php/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_empresa/get_tipos_cuenta.php')
        .then(response => response.text())
        .then(data => {
