...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // TÍTULO: FUNCIÓN PARA REINICIAR SELECCIÓN
    var resetButton = document.getElementById('reset-empresa');
    if (resetButton) {
        resetButton.addEventListener('click', function () {
            // Reset the selected option text
            OpcionSeleccionada.textContent = 'Seleccione una empresa';
            ...
            fetch('reset_empresa_session.php')
