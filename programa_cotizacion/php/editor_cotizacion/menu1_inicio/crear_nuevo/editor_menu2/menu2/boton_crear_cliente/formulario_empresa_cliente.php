...
<!-- TITULO: AQUÍ INICIA EL HTML -->
    ...
    <link rel="STYLESHEET" href="css/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_cliente/formulario_empresa_cliente.css"> 
...
<!-- TITULO: IMPORTACION DE ARCHIVO .JS -->
    ...
    <!-- Llama al archivo JS -->
    <script src="js/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_cliente/formulario_empresa_cliente.js"></script> 
