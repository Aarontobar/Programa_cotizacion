...
<!-- TITULO: IMPORTACIÓN DE ARCHIVO .CSS -->
    ...
    <link rel="stylesheet" href="css/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_crear_empresa/upload_logo.css">
    ...
    <!-- TÍTULO: CREA UNA CAJA PARA EL LOGO O FOTO DE PERFIL, OCUPANDO 6 DE LAS 12 COLUMNAS DISPONIBLES EN EL DISEÑO -->
        ...
        <label for="subir-logo" class="contenedor-logo"> 
            ...
            <!-- TÍTULO: ETIQUETA PARA EL CAMPO DE CARGA DE IMAGEN. EL ATRIBUTO "FOR" ENLAZA CON EL INPUT DE ARCHIVO -->
                ...
                <img src="../../imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/crear_empresa_principal/generic-logo.png" alt="tamaño recomendado: 800x200 pixeles" class="logo" id="Previsualizar-logo"> 
...
if (isset($_FILES['logo_upload']) && $_FILES['logo_upload']['error'] == UPLOAD_ERR_OK) {
    $upload_dir = '../../imagenes/editor_cotizacion/menu1_inicio/crear_nuevo/editor_menu2/menu2/crear_empresa/logo/';
