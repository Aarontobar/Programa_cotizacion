...
<!-- ------------------------------------------------------------------------------------------------------------
    ------------------------------------- INICIO ITred Spa Crear nuevo.PHP --------------------------------------
    ------------------------------------------------------------------------------------------------------------- -->
    <!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <div class="crear_nuevo">
        <!-- Incluye el archivo PHP crear_nuevo.php -->
        <?php include 'php/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/editor_menu2_pr.php'; ?>
    </div>
    <p>crear_nuevo</p>
