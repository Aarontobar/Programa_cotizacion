...
<!-- ------------------------------------------------------------------------------------------------------------
    ...
    <!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .CSS -->
        ...
        <link rel="stylesheet" href="../../../css/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton5_ver_cotizacion/posicionar_firma.css">
...
<!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .JS -->
    ...
    <!-- llama la archivo js -->
    <script src="../../../js/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton5_ver_cotizacion/posicionar_firma.js"></script>
