...
<!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .CSS -->
    ...
    <link rel="stylesheet" href="../../css/menu_principal/crear_nuevo/menu_2_programas/boton5_ver_cotizacion/ver_condiciones.css">


<!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .JS -->

    <!-- llama al archivo JS -->
    <script src="../../js/menu_principal/crear_nuevo/menu_2_programas/boton5_ver_cotizacion/ver_condiciones.js"></script>
