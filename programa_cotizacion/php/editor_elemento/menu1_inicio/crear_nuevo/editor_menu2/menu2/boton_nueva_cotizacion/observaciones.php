...
<!-- ------------------------------------------------------------------------------------------------------------
 ...
 <!--TITULO: ARCHIVO CSS  -->
    ...
    <link rel="stylesheet" href="css/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_nueva_cotizacion/observaciones.css">
...
<!-- TITULO: llama al archivo JS -->
    <!--------archivo JS------------------------>
    <script src="js/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_nueva_cotizacion/observaciones.js"></script> 
