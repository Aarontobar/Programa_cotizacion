...
<!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .CSS -->
    <!-- Llama al archivo JS -->
    <link rel="stylesheet" href="css/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_ver_cotizacion/obligaciones_cliente.css">
...
<!-- TÍTULO: IMPORTACIÓN DE ARCHIVO .JS -->
    ...
    <!-- Llama al archivo JS -->
    <script src="js/editor_elemento/menu1_inicio/crear_nuevo/editor_menu2/menu2/boton_ver_cotizacion/obligaciones_cliente.js"></script> 
