...
<!-- TITULO: IMPORTACIÓN DE ARCHIVO .CSS -->
    ...
    <link rel="stylesheet" href="../../../../css/menu_principal/crear_nuevo/crear_cliente/mostrar_clientes.css">
...
<!-- TITULO: IMPORTACION DE ARCHIVO .JS -->
    ...
    <!-- Llama al archivo JS -->
    <script src="../../../../js/menu_principal/crear_nuevo/crear_cliente/mostrar_clientes.js"></script>
</body>
