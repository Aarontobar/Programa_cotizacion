...
<!-- TITULO: IMPORTACIÓN DE ARCHIVO .CSS -->
    ...
    <link rel="stylesheet" href="../../css/menu_principal/crear_nuevo/menu_2_programas/boton5_ver_cotizacion/detalle.css">


<!-- TITULO: IMPORTACION DE ARCHIVO .JS -->

    <!-- Llama al archivo JS -->
    <script src="../../js/menu_principal/crear_nuevo/menu_2_programas/boton5_ver_cotizacion/detalle.js"></script>
