...
<!-- ------------------------------------------------------------------------------------------------------------
 ...
 <!--TITULO: ARCHIVO CSS  -->
    ...
    <link rel="stylesheet" href="../../../../css/menu_principal/crear_nuevo/nueva_cotizacion/observaciones.css">
...
<!-- TITULO: llama al archivo JS -->
    <!--------archivo JS------------------------>
    <script src="../../../../js/menu_principal/crear_nuevo/nueva_cotizacion/observaciones.js"></script> 
